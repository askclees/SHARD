...
public sealed class WalTransactionPageEntryViewModel(uint pageNumber, string? tableName, IWalPageComparisonViewModel? comparison)
{
    ...
    public IWalPageComparisonViewModel? Comparison { get; } = comparison;
